...
\textbf{PixelCNN}: also from corner, but condition by CNN over context region (receptive field) $ \Rightarrow $ parallelize.
...
Use dilated convolutions to increase receptive field with multiple layers.
